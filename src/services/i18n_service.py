...
class I18nService:
        ...
        for lang in Language:
            ...
            if lang_file.exists():
                try:
                    ...
                    logger.info("Loaded translations", extra={"language": lang.value})
                ...
                logger.warning(
                    "Translation file not found", extra={"lang_file": str(lang_file)}
                )
    ...
    def _get_translation(self, key: str, lang: str) -> str:
        ...
        for k in keys:
            if isinstance(value, dict) and k in value:
                ...
                logger.warning(
                    "Translation not found", extra={"key": key, "language": lang}
                )
                return f"[{key}]"
    ...
    def set_default_language(self, language: Language):
        ...
        logger.info("Default language set", extra={"language": language.value})
    ...
    def add_custom_translation(self, key: str, language: Language, value: str):
        ...
        logger.info("Added custom translation", extra={"key": key, "language": lang})
