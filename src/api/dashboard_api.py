# [NEXUS IDENTITY] ID: -2515527455942735127 | DATE: 2025-11-19
...
async def get_ba_dashboard(
    ...
    try:
        async with db_pool.acquire() as conn:
            ...
            completion_percent = (
                int((completed_features / total_features * 100))
                if total_features > 0
                else 0
            )
            ...
            if completion_percent < 50:
                ...
                recommendations.append(
                    "Prioritize feature completion to reach market readiness"
                )
            ...
            if blocked_requirements > 0:
                ...
                recommendations.append(
                    f"Unblock {blocked_requirements} requirements to maintain velocity"
                )
...
async def get_owner_dashboard(
    ...
    try:
        async with db_pool.acquire() as conn:
            ...
            customers_count = (
                await conn.fetchval("SELECT COUNT(*) FROM tenants WHERE active = true")
                or 0
            )
...
def _get_demo_owner_dashboard() -> Dict[str, Any]:
    ...
    return {
        ...
        "customers": {"total": 42, "new_this_month": 7},
        "growth_percent": 23,
