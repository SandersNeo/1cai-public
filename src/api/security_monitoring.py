...
async def get_security_alerts(
    ...
    try:
        ...
        logger.info(
            ...
            extra={"limit": limit, "alerts_count": len(limited_alerts)},
        )
        ...
        logger.error(
            ...
            extra={"limit": limit, "error_type": type(e).__name__},
            exc_info=True,
        )
        raise HTTPException(
...
async def get_audit_log(
    agent_id: Optional[str] = None, event_type: Optional[str] = None, limit: int = 100
):
    """
