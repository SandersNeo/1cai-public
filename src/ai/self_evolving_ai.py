...
class SelfEvolvingAI:
    ...
    def __init__(
        ...
        self.event_publisher = EventPublisher(event_bus or EventBus(), "self-evolving-ai")
    ...
    async def evolve(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "performance_after": (await self._analyze_performance()).to_dict() if applied else None
            }
    ...
    async def _evaluate_improvements(
        ...
        best.sort(
            key=lambda i: sum(i.expected_improvement.values()),
            reverse=True
        )
