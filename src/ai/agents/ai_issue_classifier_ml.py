...
class MLIssueClassifier:
    ...
    def __init__(self):
        ...
        try:
            ...
            if os.path.exists(model_path):
                logger.info(
                    "Loading classifier model", extra={"model_path": model_path}
                )
    ...
    def _generate_labels(
        self, title: str, description: str, issue_type: str
    ) -> List[str]:
    ...
    async def auto_label_issue(self, issue_id: str, title: str, description: str):
        ...
        try:
            ...
            logger.info(
                "Auto-labeled issue",
                extra={"issue_id": issue_id, "classification": classification},
            )
