...
34. **Блок \"Последние улучшения\" в README** — при любых существенных изменениях кода/архитектуры/доков обновляем краткий дайджест за текущую дату, чтобы он соответствовал CHANGELOG и фактическому состоянию.
35. **Архитектура** — при добавлении/изменении подсистем, сценариев или важных потоков (Scenario Hub, ToolRegistry, DR, BA→Dev→QA и т.п.) обязательно проверяем и при необходимости обновляем архитектурные документы (`docs/architecture/*`, диаграммы C4/PlantUML, интерактивную архитектуру), чтобы они совпадали с реализацией.
