...
ARCHITECTURE_PATTERNS = {
    ...
    "event_sourcing": ArchitecturePattern(
        ...
        """,
        examples=["1C документы и движения", "Event Store", "CQRS + Event Sourcing"],
    ...
    "api_gateway": ArchitecturePattern(
        ...
        """,
        examples=["Netflix Zuul", "Kong API Gateway", "nginx перед 1С HTTP-сервисами"],
    ...
    "caching_strategy": ArchitecturePattern(
        ...
        drawbacks=["Сложность инвалидации", "Потребление памяти", "Stale data риск"],
        bsl_adaptation="""
        Уровни кэша в 1С:
    ...
    "nanoservices": ArchitecturePattern(
        ...
        """,
        use_cases=["ИЗБЕГАТЬ: Не использовать этот паттерн!"],
        benefits=[],
        drawbacks=[
    ...
    "god_object": ArchitecturePattern(
        ...
        - "РаботаСОплатами"
        """,
        examples=["Monolithic utility classes", "1C общие модули с тысячами строк"],
...
class PatternMatcher:
    ...
    def suggest_patterns(
        self, problem_description: str, context: Dict[str, Any] = None
    ...
    def validate_architecture(self, architecture_description: str) -> Dict[str, Any]:
        """
