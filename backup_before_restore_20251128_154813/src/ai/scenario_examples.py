...
def example_empty_execution_report(
        plan: ScenarioPlan) -> ScenarioExecutionReport:
    """
    ...
    trust = TrustScore(score=0.5, level="medium", reasons=[
        "Пример-заглушка, без реальных метрик"])
