...
async def start_dashboard_updater():
    ...
    from src.modules.dashboard.services.developer_service import \
        DeveloperService
    from src.modules.dashboard.services.executive_service import \
        ExecutiveService
    ...
    from src.modules.dashboard.services.team_lead_service import \
        TeamLeadService
