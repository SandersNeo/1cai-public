...
class EventBus:
    ...
    def __init__(self, backend: str = "memory"):
        ...
        logger.info("EventBus initialized with backend: %s")
    ...
    async def start(self, num_workers: int = 4) -> None:
        ...
        logger.info("EventBus started with %s workers")
    ...
    async def _worker(self, worker_id: str) -> None:
        ...
        logger.info("Event worker %s started")
        ...
        logger.info("Event worker %s stopped")
    ...
    async def _process_event(self, event: Event) -> None:
        ...
        if not handlers:
            logger.debug("No handlers for event type: {event.type.value}")
            return
